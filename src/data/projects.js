...
export const projects = [
  ...
  },
  {
    ...
    tech: ['Unity', 'URP 2D', 'C#', 'Game Design'],
    year: '2023',
    mode: 'iso',
    scene: { iso: true },
    embed: null,
    ...
    summary: {
      fr: 'Rogue-like isométrique en 2.5D inspiré de Dofus, réalisé en équipe pendant mon stage à Setúbal : on traverse deux niveaux générés, on combat et on remplit ses poches d’or. Développé sous Unity, à partir d’assets graphiques Kenney.',
      en: 'An isometric 2.5D roguelike inspired by Dofus, built with a team during my internship in Setúbal: cross two generated levels, fight and fill your pockets with gold. Built in Unity, using Kenney graphic assets.',
    },
    about: {
      fr: [
        'Fill Your Pockets est un rogue-like isométrique 2.5D à la Dofus : deux niveaux, un héros qui explore, ramasse l’or, affronte des Grogs et déjoue des pièges avant la sortie. Projet d’équipe côté développement (Unity, URP 2D, C#), habillé avec des assets graphiques Kenney.',
        'La scène ci-dessus rejoue une prairie avec les vrais assets du jeu (tuiles, personnages et UI Kenney) : déplace le héros (ZQSD / flèches), ramasse les bourses d’or, ouvre le coffre et frappe le Grog (Espace / clic) sur l’herbe, le chemin et le pont, le long de la rivière et de la mare.',
      ],
      en: [
        'Fill Your Pockets is an isometric 2.5D roguelike à la Dofus: two levels, a hero who explores, grabs gold, fights Grogs and dodges traps before the exit. A team project on the development side (Unity, 2D URP, C#), dressed with Kenney graphic assets.',
        'The scene above replays a meadow with the game’s real assets (Kenney tiles, characters and UI): move the hero (WASD / arrows), grab the gold purses, open the chest and hit the Grog (Space / click) across grass, the path and the bridge, along the river and pond.',
      ],
    },
    cover: null,
    gallery: [
      'images/fyp/logo.webp',
      'images/fyp/menu.webp',
      'images/fyp/level1.webp',
      'images/fyp/ui-panels.webp',
