  ...
  },
  {
    ...
    about: {
      fr: [
        ...
        'La scène ci-dessus rejoue une prairie avec mes vrais sprites : déplace le héros (ZQSD / flèches), ramasse les bourses d’or et frappe le Grog (Espace / clic) sur l’herbe, le chemin et le pont, le long de la rivière et de la mare. Côté équipe, développé sous Unity (URP 2D, C#) pendant le stage.',
      ],
      en: [
        ...
        'The scene above replays a meadow with my real sprites: move the hero (WASD / arrows), grab the gold purses and hit the Grog (Space / click) across grass, the path and the bridge, along the river and pond. As a team, built in Unity (2D URP, C#) during the internship.',
      ],
    },
    cover: null,
    gallery: [],
