...
const dict = {
  fr: {
    ...
    pv_play: 'Jouer',
    pv_link_play: 'Jouer en ligne',
    pv_link_visit: 'Voir le site',
    pv_link_download: 'Télécharger',
    pv_link_source: 'Code source',
    pv_gallery: 'Aperçus',
    ...
    pv_iso_verb: 'Déplace-toi, ramasse l’or',
    pv_iso_keys: 'ZQSD · Espace : frapper',
    pv_dungeon_verb: 'Explore, combats à la dague',
    pv_dungeon_keys: 'ZQSD · Espace : frapper',
    cur_view: 'VOIR',
    cur_back: 'RETOUR',
    cur_next: 'SUIVANT',
  },
  en: {
    ...
    pv_play: 'Play',
    pv_link_play: 'Play online',
    pv_link_visit: 'Visit the site',
    pv_link_download: 'Download',
    pv_link_source: 'Source code',
    pv_gallery: 'Glimpses',
    ...
    pv_iso_verb: 'Move, grab the gold',
    pv_iso_keys: 'WASD · Space: attack',
    pv_dungeon_verb: 'Explore, fight with the dagger',
    pv_dungeon_keys: 'WASD · Space: attack',
    cur_view: 'VIEW',
    cur_back: 'BACK',
    cur_next: 'NEXT',
  },
